...
def plot_overlaps_percentage(overlap_information):
    ...
    overlaps_binary = overlaps_binary[
        overlaps_binary["Exposure Type"] == "Partial Overlap"
    ]
...
def plot_overlaps_count(overlap_information):
    ...
    overlaps_count = overlaps_count[
        overlaps_count["Exposure Type"] == "Partial Overlap"
    ]
    ...
    g.tight_layout()
    g.savefig(f"overlap_between_datasets_count.png", bbox_inches="tight", dpi=300)
    plt.clf()
